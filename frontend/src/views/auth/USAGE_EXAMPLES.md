...
This document provides practical examples of how to use the authentication views in the ExAPI frontend.
...
//   - Token stored in localStorage
//   - User data stored in state
//   - Success toast: "Account created successfully! Welcome to ExAPI."
