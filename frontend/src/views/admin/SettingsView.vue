...
import { SETTINGS_TABS, getNextSettingsTab } from "./settings/useSettingsTabs";
...
function markSmtpPasswordManuallyEdited(): void {
  smtpPasswordManuallyEdited.value = true;
}

function updateTestEmailAddress(value: string): void {
...
function removeQuotaNotifyEmail(index: number): void {
