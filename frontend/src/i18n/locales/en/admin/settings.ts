export default {
    settings: {
      ...
      privateControlPlane: {
        runtimeTitle: 'Operator runtime',
        runtimeDescription: 'Private gateway admission, monitoring, and routing controls.',
        monitoringEnabled: 'Operations monitoring',
        realtimeMonitoringEnabled: 'Realtime monitoring',
        channelMonitorEnabled: 'Channel monitoring',
        riskControlEnabled: 'Content risk controls',
        allowUngroupedKeyScheduling: 'Allow ungrouped key scheduling',
        trustForwardedIp: 'Trust forwarded IP for API-key ACLs',
        monitorInterval: 'Monitor interval (seconds)',
        metricsInterval: 'Metrics interval (seconds)',
        forwardedHeaders: 'Forwarded client-IP headers (one per line)',
        ...
        routingTitle: 'Gateway routing',
        routingDescription: 'Provider fallbacks and request normalization for the public listener.',
        modelFallback: 'Enable model fallback',
        identityPatch: 'Enable identity patch',
        fingerprintUnification: 'Unify client fingerprints',
        clientDatelineNormalization: 'Normalize client datelines',
        metadataPassthrough: 'Pass metadata upstream',
        openaiAdvancedScheduler: 'OpenAI advanced scheduler',
        identityPatchPrompt: 'Identity patch prompt',
        compatibilityTitle: 'Client compatibility',
        compatibilityDescription: 'Optional accepted-version bounds. Empty values leave a bound disabled.',
        minClaudeCodeVersion: 'Minimum Claude Code version',
        maxClaudeCodeVersion: 'Maximum Claude Code version',
        minCodexVersion: 'Minimum Codex version',
        maxCodexVersion: 'Maximum Codex version',
        allowCodexAppServerClients: 'Allow Codex app-server clients',
      },
      tabs: {
        general: 'General',
        agreement: 'Agreement',
      ...
      security: {
        privateBoundaryTitle: 'Private operator boundary',
        privateBoundaryDescription: 'Operator identity is bound to an allowed WireGuard peer by the dedicated control listener. The browser does not use passwords, passkeys, one-time codes, session tokens, OAuth login, or CAPTCHA challenges.',
        requestProtectionsTitle: 'Request protections',
        controlMarker: 'Every control request carries the explicit ExAPI control marker.',
        requestValidation: 'Host, Origin, Fetch Metadata, and operator peer address are validated server-side.',
        controlWebSockets: 'Control WebSockets negotiate the exapi-control subprotocol.',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for ExAPI end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for ExAPI end-user login',
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentHint: 'The full Codex User-Agent used for all outbound requests, for customizing the OS / arch / terminal fingerprint. If set, both leading and trailing version declarations are synchronized to the active backend version; leave empty to use the standard codex-tui identity.',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on ExAPI orders; the upstream type is sent as EasyPay type.',
