export default {
    accounts: {
      ...
      types: {
        ...
        grokSsoFiles: 'SSO Files',
        grokSsoFilesDesc: 'Import Web SSO files',
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. ExAPI cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      oauth: {
        ...
        grok: {
          ...
          buildFilesHint: 'Upload a grok2api Grok Build export (.json/.jsonl/.txt) and its refresh_token entries will be filled into the text area for review.',
          buildFilesParsed: 'Parsed {count} refresh token(s)',
          buildFilesEmpty: 'No refresh tokens were found in the selected file(s).',
          buildFilesReadFailed: 'Failed to read the selected file(s).',
          buildFilesTooManyFiles: 'Select at most 10 files at a time.',
          buildFilesFileTooLarge: 'Each selected file must be 10 MB or smaller.',
          buildFilesTotalTooLarge: 'The selected files must total 25 MB or less.',
          buildFilesTooManyTokens: 'The selected files contain more than {limit} refresh tokens.',
          ssoCookieAuth: 'SSO Cookie / Files Import',
          ...
          ssoFilesSelect: 'Choose SSO Files',
          ssoFilesHint: 'Upload .txt, .json, .jsonl, .csv, or .sso files containing Grok Web SSO keys. Parsed keys are filled into the text area for review.',
          ssoFilesParsed: 'Parsed {count} SSO key(s)',
          ssoFilesEmpty: 'No Grok SSO keys were found in the selected file(s).',
          ssoFilesReadFailed: 'Failed to read the selected file(s).',
          ssoFilesTooManyFiles: 'Select at most 10 files at a time.',
          ssoFilesFileTooLarge: 'Each selected file must be 10 MB or smaller.',
          ssoFilesTotalTooLarge: 'The selected files must total 25 MB or less.',
          ssoFilesTooManyTokens: 'The selected files contain more than {limit} SSO keys.',
      ...
      testHttpError: 'Request failed (HTTP {status})',
      testNoResponseBody: 'The server returned no response body',
      testErrorLine: 'Error: {message}',
