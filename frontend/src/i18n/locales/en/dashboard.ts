export default {
  ...
  keys: {
    ...
    secretDisplayHint: 'The full API key is shown only immediately after creation. Existing keys display a prefix and cannot be recovered; create a new key if you missed it.',
    createdKeyTitle: 'Save your new API key',
    createdKeyWarning: 'This key is shown only once and cannot be recovered. Copy it to a secure location before closing this dialog.',
    copyCreatedKey: 'Copy key',
    createdKeySaved: 'I have saved the key',
    keySecretUnavailable: 'The key was created without returning its one-time secret. Delete it and create a new key, then copy the secret before closing the dialog.',
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your ExAPI Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your ExAPI Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your ExAPI Grok group.',
