...
matches=$(rg -n --hidden \
  ...
  | rg -v 'github.com/Wei-Shaw/sub2api|otpauth://totp/Sub2API|sub2apipay|Sub2ApiPay|Sub2API-compatible|upstream Sub2API|derived from|compatibility|Historical|original upstream' || true)
