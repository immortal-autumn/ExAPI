#!/bin/bash
#
# ExAPI Installation Script
# ExAPI 安装脚本
# Usage: curl -sSL https://raw.githubusercontent.com/immortal-autumn/Sub2API2Personal/main/deploy/install.sh | bash
#
...
# Configuration
GITHUB_REPO="immortal-autumn/Sub2API2Personal"
...
declare -A MSG_ZH=(
    ...
    # Completion
    ["install_complete"]="ExAPI 安装完成！"
    ["install_dir"]="安装目录"
    ["next_steps"]="后续步骤"
    ["step1_check_services"]="确保 PostgreSQL 和 Redis 正在运行："
    ["step2_start_service"]="启动 ExAPI 服务："
    ...
    ["not_installed"]="ExAPI 尚未安装，请先执行全新安装"
    ["fresh_install_hint"]="用法"

    # Uninstall
    ["uninstall_confirm"]="这将从系统中移除 ExAPI。"
    ...
    ["usage"]="用法"
    ["cmd_none"]="(无参数)"
    ["cmd_install"]="安装 ExAPI"
    ["cmd_upgrade"]="升级到最新版本"
    ["cmd_uninstall"]="卸载 ExAPI"
    ...
    ["server_config_desc"]="配置 ExAPI 服务监听地址"
...
declare -A MSG_EN=(
    ...
    # Installation
    ["install_title"]="ExAPI Installation Script"
    ...
    # Completion
    ["install_complete"]="ExAPI installation completed!"
    ["install_dir"]="Installation directory"
    ["next_steps"]="NEXT STEPS"
    ["step1_check_services"]="Make sure PostgreSQL and Redis are running:"
    ["step2_start_service"]="Start ExAPI service:"
    ...
    ["not_installed"]="ExAPI is not installed. Please run a fresh install first"
    ["fresh_install_hint"]="Usage"

    # Uninstall
    ["uninstall_confirm"]="This will remove ExAPI from your system."
    ...
    ["usage"]="Usage"
    ["cmd_none"]="(none)"
    ["cmd_install"]="Install ExAPI"
    ["cmd_upgrade"]="Upgrade to the latest version"
    ["cmd_uninstall"]="Remove ExAPI"
    ...
    ["server_config_desc"]="Configure ExAPI server listen address"
...
Documentation=https://github.com/immortal-autumn/Sub2API2Personal
...
# Requires: ExAPI must already be installed
install_version() {
