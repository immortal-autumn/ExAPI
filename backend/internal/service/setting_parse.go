...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	result := &SystemSettings{
		...
		TencentCaptchaAppSecretKey:             settings[SettingKeyTencentCaptchaAppSecretKey],
		TencentCaptchaAppSecretKeyConfigured:   settings[SettingKeyTencentCaptchaAppSecretKey] != "",
		TencentCaptchaCloudSecretID:            settings[SettingKeyTencentCaptchaCloudSecretID],
		TencentCaptchaCloudSecretIDConfigured:  settings[SettingKeyTencentCaptchaCloudSecretID] != "",
		TencentCaptchaCloudSecretKey:           settings[SettingKeyTencentCaptchaCloudSecretKey],
		...
		AliyunCaptchaAccessKeySecret:           settings[SettingKeyAliyunCaptchaAccessKeySecret],
		...
		SiteName:                               s.getStringOrDefault(settings, SettingKeySiteName, "ExAPI"),
	...
	if value, ok := settings[SettingKeyOpenAICodexVersionAutoSyncEnabled]; ok && strings.TrimSpace(value) != "" {
