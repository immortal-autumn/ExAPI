...
// This file owns the pure candidate filtering, ordering, tie grouping, and
// shuffle helpers used by gateway account selection. It intentionally performs
// no I/O, slot acquisition, cache access, retries, or billing work.
