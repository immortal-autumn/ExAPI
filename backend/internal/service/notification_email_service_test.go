...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "ExAPI", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "ExAPI", "https://example.com/reset", "en-US"))
