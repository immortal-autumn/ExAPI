...
func init() {
	...
	// apikeyDescKeyDigest is the schema descriptor for key_digest field.
	apikeyDescKeyDigest := apikeyFields[2].Descriptor()
	// apikey.KeyDigestValidator is a validator for the "key_digest" field. It is called by the builders before save.
	apikey.KeyDigestValidator = apikeyDescKeyDigest.Validators[0].(func(string) error)
